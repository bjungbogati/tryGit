...
const IndexPage = () => (
  <div>
    ...
    <h3>Step 1</h3>
    <p>
      Go to the <a target="_blank" href="https://github.com/bjungbogati/tryGit"> GitHub repository </a> of this project and fork the project to your account. <i className="em em-knife_fork_plate"></i>  
    ...
    <p>
      ...
      <Code code="git clone https://github.com/YOUR_USERNAME/tryGit.git"/>
    </p>
    <h3>Step 3</h3>
    <p>
    ...
    <h3>Step 7</h3>
    <p>
      Now, open your web browser and goto the <a target="_blank" href="https://github.com/bjungbogati/tryGit"> original repository on GitHub</a>. If your changes has been pushed to your forked copy, You'll be able to see an option saying "New Pull Request" in the original repository.
